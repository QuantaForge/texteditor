...
* [#16811](http://dev.texteditor.com/ticket/16811): Fixed: Table alignment is not preserved by the [Paste from Word](http://texteditor.com/addon/pastefromword) plugin.
...
* [#3336](http://dev.texteditor.com/ticket/3336): Fixed: Extra blank row added on top of the content [pasted from Word](http://texteditor.com/addon/pastefromword).
...
* [#14701](http://dev.texteditor.com/ticket/14701): Fixed: More precise labels for [Enhanced Image](http://texteditor.com/addon/image2) and [Placeholder](http://texteditor.com/addon/placeholder) widgets.
...
* [#9856](http://dev.texteditor.com/ticket/9856): Fixed: Cannot use the native context menu together with the [Div Editing Area](http://texteditor.com/addon/divarea) plugin. Thanks to [Mark Wade](https://github.com/mark-wade)!
...
* [#13441](http://dev.texteditor.com/ticket/13441): [Edge] Fixed: The [Clipboard](http://texteditor.com/addon/clipboard) plugin breaks the state of [Undo](http://texteditor.com/addon/undo) commands after a paste.
...
* [#13176](http://dev.texteditor.com/ticket/13176): [IE8] Fixed: Errors on drag&drop of embed widgets.
...
* [#11811](http://dev.texteditor.com/ticket/11811): Fixed: Widget's data is not encoded correctly when passed to an attribute.
* [#11777](http://dev.texteditor.com/ticket/11777): Fixed encoding ampersand in the [Mathematical Formulas](http://texteditor.com/addon/mathjax) plugin.
* [#11880](http://dev.texteditor.com/ticket/11880): [IE8-9] Fixed: Linked image has a default thick border.

Other Changes:

* [#11807](http://dev.texteditor.com/ticket/11807): Updated jQuery version used in the sample to 1.11.0 and tested CKEditor jQuery Adapter with version 1.11.0 and 2.1.0.
* [#9504](http://dev.texteditor.com/ticket/9504): Stopped using deprecated `attribute.specified` in all browsers except Internet Explorer.
* [#11809](http://dev.texteditor.com/ticket/11809): Changed tab size in `<pre>` to 4 spaces.
...
* [#11677](http://dev.texteditor.com/ticket/11677): Fixed: Undo/Redo keystrokes are blocked in the source mode.
* [#11717](http://dev.texteditor.com/ticket/11717): [Document Properties](http://texteditor.com/addon/docprops) plugin requires the [Color Dialog](http://texteditor.com/addon/colordialog) plugin to work.
...
* [#11635](http://dev.texteditor.com/ticket/11635): Fixed: Some attributes are not protected before the content is passed through the fix bin.
* [#11660](http://dev.texteditor.com/ticket/11660): [IE] Fixed: Table content is lost when some extra markup is inside the table.
* [#11641](http://dev.texteditor.com/ticket/11641): Fixed: Switching between modes in the classic editor removes content styles for the inline editor.
* [#11568](http://dev.texteditor.com/ticket/11568): Fixed: [Styles](http://texteditor.com/addon/stylescombo) drop-down list is not enabled on selection change.
...
* [#11331](http://dev.texteditor.com/ticket/11331): A menu button will have a changed label when selected instead of using the `aria-pressed` attribute.
* [#11177](http://dev.texteditor.com/ticket/11177): Widget drag handler improvements:
  * [#11176](http://dev.texteditor.com/ticket/11176): Fixed: Initial position is not updated when the widget data object is empty.
  * [#11001](http://dev.texteditor.com/ticket/11001): Fixed: Multiple synchronous layout recalculations are caused by initial drag handler positioning causing performance issues.
...
* [#11126](http://dev.texteditor.com/ticket/11126): Fixed: Native Undo executed once the bottom of the snapshot stack is reached.
* [#11131](http://dev.texteditor.com/ticket/11131): [Div Editing Area](http://texteditor.com/addon/divarea): Fixed: Error thrown when switching to source mode if the selection was in widget's nested editable.
* [#11139](http://dev.texteditor.com/ticket/11139): [Div Editing Area](http://texteditor.com/addon/divarea): Fixed: Elements Path is not cleared after switching to source mode.
...
* [#10787](http://dev.texteditor.com/ticket/10787): [Firefox] Fixed: Broken replacement of text while pasting into `div`-based editor.
* [#10884](http://dev.texteditor.com/ticket/10884): Widgets integration with the [Show Blocks](http://texteditor.com/addon/showblocks) plugin.
* [#11021](http://dev.texteditor.com/ticket/11021): Fixed: An error thrown when selecting entire editable contents while fake selection is on.
* [#11086](http://dev.texteditor.com/ticket/11086): [IE8] Re-enable inline widgets drag&drop in Internet Explorer 8.
* [#11372](http://dev.texteditor.com/ticket/11372): Widgets: Special characters encoded twice in nested editables.
* [#10068](http://dev.texteditor.com/ticket/10068): Fixed: Support for protocol-relative URLs.
* [#11283](http://dev.texteditor.com/ticket/11283): [Enhanced Image](http://texteditor.com/addon/image2): A `<div>` element with `text-align: center` and an image inside is not recognised correctly.
* [#11196](http://dev.texteditor.com/ticket/11196): [Accessibility Instructions](http://texteditor.com/addon/a11yhelp): Allowed additional keyboard button labels to be translated in the dialog window.

## CKEditor 4.3.1

**Important Notes:**

* To match the naming convention, the `language` button is now `Language` ([#11201](http://dev.texteditor.com/ticket/11201)).
* [Enhanced Image](http://texteditor.com/addon/image2) button, context menu, command, and icon names match those of the [Image](http://texteditor.com/addon/image) plugin ([#11222](http://dev.texteditor.com/ticket/11222)).
...
* [#11165](http://dev.texteditor.com/ticket/11165): Fixed: The [File Browser](http://texteditor.com/addon/filebrowser) plugin cannot be removed from the editor.
* [#11159](http://dev.texteditor.com/ticket/11159): [IE9-10] [Enhanced Image](http://texteditor.com/addon/image2): Fixed buggy discovery of image dimensions.
* [#11101](http://dev.texteditor.com/ticket/11101): Drop-down lists no longer break when given double quotes.
* [#11077](http://dev.texteditor.com/ticket/11077): [Enhanced Image](http://texteditor.com/addon/image2): Empty undo step recorded when resizing the image.
...
* [#11200](http://dev.texteditor.com/ticket/11200):  Added [Clipboard](http://texteditor.com/addon/clipboard) plugin as a dependency for [Widget](http://texteditor.com/addon/widget) to fix drag and drop.

## CKEditor 4.3

New Features:

* [#10612](http://dev.texteditor.com/ticket/10612): Internet Explorer 11 support.
* [#10869](http://dev.texteditor.com/ticket/10869): Widgets: Added better integration with the [Elements Path](http://texteditor.com/addon/elementspath) plugin.
* [#10886](http://dev.texteditor.com/ticket/10886): Widgets: Added tooltip to the drag handle.
...
* [#10937](http://dev.texteditor.com/ticket/10937): [Mathematical Formulas](http://texteditor.com/addon/mathjax) widget improvements:
  ...
  * Firefox and IE9 clipboard fixes ([#10857](http://dev.texteditor.com/ticket/10857)),
  * fixing same origin policy issue ([#10840](http://dev.texteditor.com/ticket/10840)),
  * fixing undo bugs ([#10842](http://dev.texteditor.com/ticket/10842), [#10930](http://dev.texteditor.com/ticket/10930)),
...
* [#10831](http://dev.texteditor.com/ticket/10831): [Enhanced Image](http://texteditor.com/addon/image2): Merged `image2inline` and `image2block` into one `image2` widget.
* [#10835](http://dev.texteditor.com/ticket/10835): [Enhanced Image](http://texteditor.com/addon/image2): Improved visibility of the resize handle.
* [#10836](http://dev.texteditor.com/ticket/10836): [Enhanced Image](http://texteditor.com/addon/image2): Preserve custom mouse cursor while resizing the image.
* [#10939](http://dev.texteditor.com/ticket/10939): [Firefox] [Enhanced Image](http://texteditor.com/addon/image2): hovering the image causes it to change.
* [#10866](http://dev.texteditor.com/ticket/10866): Fixed: Broken *Tab* key navigation in the [Enhanced Image](http://texteditor.com/addon/image2) dialog window.
* [#10833](http://dev.texteditor.com/ticket/10833): Fixed: *Lock ratio* option should be on by default in the [Enhanced Image](http://texteditor.com/addon/image2) dialog window.
* [#10881](http://dev.texteditor.com/ticket/10881): Various improvements to *Enter* key behavior in nested editables.
* [#10879](http://dev.texteditor.com/ticket/10879): [Remove Format](http://texteditor.com/addon/removeformat) should not leak from a nested editable.
* [#10877](http://dev.texteditor.com/ticket/10877): Fixed: [WebSpellChecker](http://texteditor.com/addon/wsc) fails to apply changes if a nested editable was focused.
* [#10877](http://dev.texteditor.com/ticket/10877): Fixed: [SCAYT](http://texteditor.com/addon/wsc) blocks typing in nested editables.
* [#11079](http://dev.texteditor.com/ticket/11079): Add button icons to the [Placeholder](http://texteditor.com/addon/placeholder) sample.
* [#10870](http://dev.texteditor.com/ticket/10870): The `paste` command is no longer being disabled when the clipboard is empty.
* [#10854](http://dev.texteditor.com/ticket/10854): Fixed: Firefox prepends `<br>` to `<body>`, so it is stripped by the HTML data processor.
* [#10823](http://dev.texteditor.com/ticket/10823): Fixed: [Link](http://texteditor.com/addon/link) plugin does not work with non-editable content.
...
* [#11083](http://dev.texteditor.com/ticket/11083): Fixed list and div element application to block widgets.
* [#10887](http://dev.texteditor.com/ticket/10887): Internet Explorer 8 compatibility issues related to the Widget System.
* [#11074](http://dev.texteditor.com/ticket/11074): Temporarily disabled inline widget drag and drop, because of seriously buggy native `range#moveToPoint` method.
* [#11098](http://dev.texteditor.com/ticket/11098): Fixed: Wrong selection position after undoing widget drag and drop.
* [#11110](http://dev.texteditor.com/ticket/11110): Fixed: IFrame and Flash objects are being incorrectly pasted in certain conditions.
* [#11129](http://dev.texteditor.com/ticket/11129): Page break is lost when loading data.
* [#11123](http://dev.texteditor.com/ticket/11123): [Firefox] Widget is destroyed after being dragged outside of `<body>`.
* [#11124](http://dev.texteditor.com/ticket/11124): Fixed the [Elements Path](http://texteditor.com/addon/elementspath) in an editor using the [Div Editing Area](http://texteditor.com/addon/divarea).
...
* [#10708](http://dev.texteditor.com/ticket/10708): New [smileys](http://texteditor.com/addon/smiley).

## CKEditor 4.2.3

Fixed Issues:

* [#10994](http://dev.texteditor.com/ticket/10994): Fixed: Loading external jQuery library when opening the [jQuery Adapter](http://docs.texteditor.com/#!/guide/dev_jquery) sample directly from file.
* [#10975](http://dev.texteditor.com/ticket/10975): [IE] Fixed: Error thrown while opening the color palette.
* [#9929](http://dev.texteditor.com/ticket/9929): [Blink/WebKit] Fixed: A non-breaking space is created once a character is deleted and a regular space is typed.
* [#10963](http://dev.texteditor.com/ticket/10963): Fixed: JAWS issue with the keyboard shortcut for [Magic Line](http://texteditor.com/addon/magicline).
* [#11096](http://dev.texteditor.com/ticket/11096): Fixed: TypeError: Object has no method 'is'.

## CKEditor 4.2.2

Fixed Issues:

* [#9314](http://dev.texteditor.com/ticket/9314): Fixed: Incorrect error message on closing a dialog window without saving changs.
...
* [#10301](http://dev.texteditor.com/ticket/10301): [IE9-10] Undo fails after 3+ consecutive paste actions with a JavaScript error.
* [#10689](http://dev.texteditor.com/ticket/10689): Save toolbar button saves only the first editor instance.
* [#10368](http://dev.texteditor.com/ticket/10368): Move language reading direction definition (`dir`) from main language file to core.
* [#9330](http://dev.texteditor.com/ticket/9330): Fixed pasting anchors from MS Word.
* [#8103](http://dev.texteditor.com/ticket/8103): Fixed pasting nested lists from MS Word.
* [#9958](http://dev.texteditor.com/ticket/9958): [IE9] Pressing the "OK" button will trigger the `onbeforeunload` event in the popup dialog.
* [#10662](http://dev.texteditor.com/ticket/10662): Fixed styles from the Styles drop-down list not registering to the ACF in case when the [Shared Spaces plugin](http://texteditor.com/addon/sharedspace) is used.
* [#9654](http://dev.texteditor.com/ticket/9654): Problems with Internet Explorer 10 Quirks Mode.
* [#9816](http://dev.texteditor.com/ticket/9816): Floating toolbar does not reposition vertically in several cases.
* [#10646](http://dev.texteditor.com/ticket/10646): Removing a selected sublist or nested table with *Backspace/Delete* removes the parent element.
* [#10623](http://dev.texteditor.com/ticket/10623): [WebKit] Page is scrolled when opening a drop-down list.
* [#10004](http://dev.texteditor.com/ticket/10004): [ChromeVox] Button names are not announced.
* [#10731](http://dev.texteditor.com/ticket/10731): [WebSpellChecker](http://texteditor.com/addon/wsc) plugin breaks cloning of editor configuration.
* It is now possible to set per instance [WebSpellChecker](http://texteditor.com/addon/wsc) plugin configuration instead of setting the configuration globally.
...
* Both the Basic and the Standard distribution packages will not contain the new [Indent Block](http://texteditor.com/addon/indentblock) plugin. Because of this the [Advanced Content Filter](http://docs.texteditor.com/#!/guide/dev_advanced_content_filter) might remove block indentations from existing contents. If you want to prevent this, either [add an appropriate ACF rule to your filter](http://docs.texteditor.com/#!/guide/dev_allowed_content_rules) or create a custom build based on the Basic/Standard package and add the Indent Block plugin in [CKBuilder](http://texteditor.com/builder).
...
* [#9945](http://dev.texteditor.com/ticket/9945): [iOS] Scrolling not possible on iPad.
* [#10389](http://dev.texteditor.com/ticket/10389): Fixed: Invalid HTML in the "Text and Table" template.
* [WebSpellChecker](http://texteditor.com/addon/wsc) plugin user interface was changed to match CKEditor 4 style.
...
* [#10172](http://dev.texteditor.com/ticket/10172): Pressing *Delete* or *Backspace* in an empty table cell moves the cursor to the next/previous cell.
* [#10219](http://dev.texteditor.com/ticket/10219): Error thrown when destroying an editor instance in parallel with a `mouseup` event.
...
* [#9829](http://dev.texteditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.
...
* [#9940](http://dev.texteditor.com/ticket/9940): [Firefox] Navigating back to a page with the editor was making the entire page editable.
* [#9966](http://dev.texteditor.com/ticket/9966): Fixed: Unable to type square brackets with French keyboard layout. Changed [Magic Line](http://texteditor.com/addon/magicline) keystrokes.
* [#9507](http://dev.texteditor.com/ticket/9507): [Firefox] Selection is moved before editable position when the editor is focused for the first time.
* [#9947](http://dev.texteditor.com/ticket/9947): [WebKit] Editor overflows parent container in some edge cases.
* [#10105](http://dev.texteditor.com/ticket/10105): Fixed: Broken [sourcearea](http://texteditor.com/addon/sourcearea) view when an RTL language is set.
* [#10123](http://dev.texteditor.com/ticket/10123): [WebKit] Fixed: Several dialog windows have broken layout since the latest WebKit release.
* [#10152](http://dev.texteditor.com/ticket/10152): Fixed: Invalid ARIA property used on menu items.
...
* [#9655](http://dev.texteditor.com/ticket/9655): Support for IE Quirks Mode in the new [Moono skin](http://texteditor.com/addon/moono).
* Accessibility issues (mainly in inline editor): [#9364](http://dev.texteditor.com/ticket/9364), [#9368](http://dev.texteditor.com/ticket/9368), [#9369](http://dev.texteditor.com/ticket/9369), [#9370](http://dev.texteditor.com/ticket/9370), [#9541](http://dev.texteditor.com/ticket/9541), [#9543](http://dev.texteditor.com/ticket/9543), [#9841](http://dev.texteditor.com/ticket/9841), [#9844](http://dev.texteditor.com/ticket/9844).
* [Magic Line](http://texteditor.com/addon/magicline) plugin:
    * [#9481](http://dev.texteditor.com/ticket/9481): Added accessibility support for Magic Line.
    * [#9509](http://dev.texteditor.com/ticket/9509): Added Magic Line support for forms.
    * [#9573](http://dev.texteditor.com/ticket/9573): Magic Line does not disappear on `mouseout` in a specific case.
* [#9754](http://dev.texteditor.com/ticket/9754): [WebKit] Cutting & pasting simple unformatted text generates an inline wrapper in WebKit browsers.
* [#9456](http://dev.texteditor.com/ticket/9456): [Chrome] Properly paste bullet list style from MS Word.
* [#9699](http://dev.texteditor.com/ticket/9699), [#9758](http://dev.texteditor.com/ticket/9758): Improved selection locking when selecting by dragging.
* Context menu:
    * [#9712](http://dev.texteditor.com/ticket/9712): Opening the context menu destroys editor focus.
    * [#9366](http://dev.texteditor.com/ticket/9366): Context menu should be displayed over the floating toolbar.
    * [#9706](http://dev.texteditor.com/ticket/9706): Context menu generates a JavaScript error in inline mode when the editor is attached to a header element.
* [#9800](http://dev.texteditor.com/ticket/9800): Hide float panel when resizing the window.
* [#9721](http://dev.texteditor.com/ticket/9721): Padding in content of div-based editor puts the editing area under the bottom UI space.
* [#9528](http://dev.texteditor.com/ticket/9528): Host page `box-sizing` style should not influence the editor UI elements.
* [#9503](http://dev.texteditor.com/ticket/9503): [Form Elements](http://texteditor.com/addon/forms) plugin adds context menu listeners only on supported input types. Added support for `tel`, `email`, `search` and `url` input types.
* [#9769](http://dev.texteditor.com/ticket/9769): Improved floating toolbar positioning in a narrow window.
* [#9875](http://dev.texteditor.com/ticket/9875): Table dialog window does not populate width correctly.
* [#8675](http://dev.texteditor.com/ticket/8675): Deleting cells in a nested table removes the outer table cell.
* [#9815](http://dev.texteditor.com/ticket/9815): Cannot edit dialog window fields in an editor initialized in the jQuery UI modal dialog.
* [#8888](http://dev.texteditor.com/ticket/8888): CKEditor dialog windows do not show completely in a small window.
* [#9360](http://dev.texteditor.com/ticket/9360): [Inline editor] Blocks shown for a `<div>` element stay permanently even after the user exits editing the `<div>`.
* [#9531](http://dev.texteditor.com/ticket/9531): [Firefox & Inline editor] Toolbar is lost when closing the Format drop-down list by clicking its button.
* [#9553](http://dev.texteditor.com/ticket/9553): Table width incorrectly set when the `border-width` style is specified.
* [#9594](http://dev.texteditor.com/ticket/9594): Cannot tab past CKEditor when it is in read-only mode.
* [#9658](http://dev.texteditor.com/ticket/9658): [IE9] Justify not working on selected images.
* [#9686](http://dev.texteditor.com/ticket/9686): Added missing contents styles for `<pre>` elements.
* [#9709](http://dev.texteditor.com/ticket/9709): [Paste from Word](http://texteditor.com/addon/pastefromword) should not depend on configuration from other styles.
* [#9726](http://dev.texteditor.com/ticket/9726): Removed [Color Dialog](http://texteditor.com/addon/colordialog) plugin dependency from [Table Tools](http://texteditor.com/addon/tabletools).
* [#9765](http://dev.texteditor.com/ticket/9765): Toolbar Collapse command documented incorrectly in the [Accessibility Instructions](http://texteditor.com/addon/a11yhelp) dialog window.
* [#9771](http://dev.texteditor.com/ticket/9771): [WebKit & Opera] Fixed scrolling issues when pasting.
...
[1]: http://docs.texteditor.com/#!/guide/dev_api_changes "API Changes"
